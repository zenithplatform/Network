...
{
    public class NodeTcpListener : IMessagingListener
    {
        ...
        public NodeTcpListener(ChannelTcpListenerConfiguration configuration)
        {
        ...
        /// <summary>
        /// </summary>
        public NodeTcpListener() : this(new ChannelTcpListenerConfiguration(
